      ...
      >
        <View style={styles.card}>
          ...
          <View style={styles.headerSection}>
            ...
            <Text style={styles.subheading}>Choose your role to sign in</Text>
          </View>

          {/* Role Selection Section */}
          <View style={styles.selectionSection}>
            {/* User Option */}
            <TouchableOpacity onPress={handleUserLogin} style={styles.roleCard}>
              ...
              <Text style={styles.roleTitle}>Customer Login</Text>
            ...
            >
              ...
              <Text style={styles.roleTitle}>Barber Login</Text>
              <Text style={styles.roleDescription}>
                Sign in to manage your salon and accept bookings
              </Text>
            </TouchableOpacity>
          </View>
